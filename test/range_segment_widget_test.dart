...
void main() {
  group('RangeSegmentWidget Tests', () {
    ...
    group('Widget Rendering', () {
      ...
      testWidgets('Widget renders with different colors', (
        WidgetTester tester,
      ) async {
    ...
    group('Positioning', () {
      testWidgets('Widget positions correctly with different left values', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget handles zero left position', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget handles large left position', (
        WidgetTester tester,
      ) async {
    ...
    group('Dimensions', () {
      testWidgets('Widget handles different width values', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget handles different track height values', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget handles zero width gracefully', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget handles very small dimensions', (
        WidgetTester tester,
      ) async {
        ...
        await tester.pumpWidget(
          createTestWidget(width: smallWidth, trackHeight: smallHeight),
        );
    ...
    group('Border Radius Behavior', () {
      testWidgets('Widget has no border radius when neither first nor last', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          createTestWidget(isFirst: false, isLast: false),
        );
      ...
      testWidgets('Widget has left border radius when isFirst is true', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget has right border radius when isLast is true', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget has both border radii when both first and last', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget border radius behavior with all combinations', (
        WidgetTester tester,
      ) async {
        ...
        for (final combination in combinations) {
          await tester.pumpWidget(
            createTestWidget(
              isFirst: combination['isFirst']!,
              isLast: combination['isLast']!,
            ),
          );
    ...
    group('Edge Cases', () {
      testWidgets('Widget handles extreme positioning values', (
        WidgetTester tester,
      ) async {
      ...
      testWidgets('Widget handles very large dimensions', (
        WidgetTester tester,
      ) async {
        ...
        await tester.pumpWidget(
          createTestWidget(width: largeWidth, trackHeight: largeHeight),
        );
      ...
      testWidgets('Widget handles custom colors with opacity', (
        WidgetTester tester,
      ) async {
    ...
    group('Multiple Segments', () {
      testWidgets('Multiple segments can be rendered together', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
      ...
      testWidgets('Segments maintain individual properties when multiple', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
        ...
        final List<Positioned> positionedWidgets = tester
        ...
        final List<Size> containerSizes = containerWidgets.asMap().entries.map((
          entry,
        ) {
    ...
    group('Decoration Properties', () {
      testWidgets('Widget always has BoxDecoration', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('Widget decoration has correct type of border radius', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets(
        'Widget maintains consistent decoration structure across different states',
    ...
    group('Open Segment Arrow Rendering', () {
      testWidgets('Widget renders without CustomPaint when not open', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          createTestWidget(isOpenEnded: false, isOpenStarted: false),
        );
      ...
      testWidgets('Widget renders CustomPaint when isOpenEnded and isLast', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          createTestWidget(isOpenEnded: true, isLast: true),
        );
      ...
      testWidgets('Widget renders CustomPaint when isOpenStarted and isFirst', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          createTestWidget(isOpenStarted: true, isFirst: true),
        );
      ...
      testWidgets(
        'Widget renders CustomPaint when both open flags are true and segment is both first and last',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(
              isOpenEnded: true,
      ...
      testWidgets(
        'Widget does not render CustomPaint when isOpenEnded but not isLast',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(isOpenEnded: true, isLast: false),
          );
      ...
      testWidgets(
        'Widget does not render CustomPaint when isOpenStarted but not isFirst',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(isOpenStarted: true, isFirst: false),
          );
      ...
      testWidgets('CustomPaint has correct size when rendered', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          createTestWidget(isOpenEnded: true, isLast: true, trackHeight: 10.0),
        );
      ...
      testWidgets(
        'CustomPaint is positioned correctly for open ended segment',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(isOpenEnded: true, isLast: true, trackHeight: 8.0),
          );
      ...
      testWidgets(
        'CustomPaint is positioned correctly for open started segment',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(
              isOpenStarted: true,
    ...
    group('Open Segment Border Radius Behavior', () {
      testWidgets(
        'Widget has no left border radius when isFirst and isOpenStarted',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(isFirst: true, isOpenStarted: true),
          );
      ...
      testWidgets(
        'Widget has no right border radius when isLast and isOpenEnded',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(isLast: true, isOpenEnded: true),
          );
      ...
      testWidgets(
        'Widget has left border radius when isFirst but not isOpenStarted',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(isFirst: true, isOpenStarted: false),
          );
      ...
      testWidgets(
        'Widget has right border radius when isLast but not isOpenEnded',
        (WidgetTester tester) async {
          await tester.pumpWidget(
            createTestWidget(isLast: true, isOpenEnded: false),
          );
    ...
    group('Stack and Container Structure', () {
      testWidgets('Widget contains Stack with correct clipBehavior', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('Widget has SizedBox with correct dimensions', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(
          createTestWidget(width: 150.0, trackHeight: 12.0),
        );
