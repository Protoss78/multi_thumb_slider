...
void main() {
  group('CustomMultiThumbSlider Comprehensive Tests', () {
    ...
    group('Gesture Handling and Drag Operations', () {
      testWidgets('Thumb drag start sets correct drag state', (WidgetTester tester) async {
      ...
      testWidgets('Thumb drag respects boundary constraints', (WidgetTester tester) async {
        List<int> currentValues = [25, 75];
        List<int>? lastCallbackValues;
      ...
      testWidgets('Multiple thumbs can be dragged independently', (WidgetTester tester) async {
      ...
      testWidgets('Tap on slider area moves nearest thumb', (WidgetTester tester) async {
        List<int> currentValues = [25, 75];
        List<int>? lastCallbackValues;
      ...
      testWidgets('Read-only mode prevents all gesture interactions', (WidgetTester tester) async {
        List<int> currentValues = [25, 75];
    ...
    group('Tickmark Interactions', () {
      testWidgets('Clicking tickmarks moves closest thumb', (WidgetTester tester) async {
        List<int> currentValues = [25, 75];
        List<int>? lastCallbackValues;
      ...
      testWidgets('Tickmark labels are clickable when enabled', (WidgetTester tester) async {
        List<int> currentValues = [25, 75];
        List<int>? lastCallbackValues;
      ...
      testWidgets('Tickmarks respect interval configuration', (WidgetTester tester) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<int>(
              values: [50],
    ...
    group('State Management and Touch Feedback', () {
      testWidgets('Drag state properly manages thumb indices', (WidgetTester tester) async {
        List<int> currentValues = [25, 75];
    ...
    group('Height Calculations and Layout', () {
      testWidgets('Height adjusts for tickmarks above track', (WidgetTester tester) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<int>(
              values: [50],
      ...
      testWidgets('Height adjusts for tickmarks below track', (WidgetTester tester) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<int>(
              values: [50],
      ...
      testWidgets('Height adjusts for tickmark labels', (WidgetTester tester) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<int>(
              values: [50],
    ...
    group('Value Type Handling', () {
      ...
      testWidgets('Enum values work with allPossibleValues', (WidgetTester tester) async {
        ...
        expect(find.byType(CustomMultiThumbSlider<TestDifficulty>), findsOneWidget);
    ...
    group('Segment Display Integration', () {
      testWidgets('Segments show for numeric types', (WidgetTester tester) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<int>(
              values: [25, 75],
      ...
      testWidgets('Segments don\'t show for non-numeric types', (WidgetTester tester) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<TestDifficulty>(
      ...
      testWidgets('Segment edit mode shows add/remove buttons', (WidgetTester tester) async {
        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<int>(
              values: [25, 75],
    ...
    group('Edge Cases and Error Handling', () {
      testWidgets('Handles rapid successive drags', (WidgetTester tester) async {
        ...
        final thumbFinder = find
            .descendant(of: find.byType(CustomMultiThumbSlider<int>), matching: find.byType(GestureDetector))
      ...
      testWidgets('Handles drag outside slider bounds', (WidgetTester tester) async {
        List<int> currentValues = [50];
    ...
    group('Performance and Memory', () {
      testWidgets('Handles many thumbs efficiently', (WidgetTester tester) async {
        List<int> currentValues = List.generate(20, (i) => i * 5); // 20 thumbs

        await tester.pumpWidget(
          TestConfig.createTestApp(
            child: CustomMultiThumbSlider<int>(values: currentValues, min: 0, max: 100, onChanged: (newValues) {}),
          ),
        );
    ...
    group('Segment Description Feature', () {
      testWidgets('getSegmentsWithDescriptions should work with numeric types', (WidgetTester tester) async {
        final GlobalKey<State<CustomMultiThumbSlider<int>>> sliderKey = GlobalKey();
        List<int> currentValues = [25, 75];
        ...
        final CustomMultiThumbSlider<int> slider = tester.widget(find.byKey(sliderKey));
      ...
      testWidgets('getSegmentsWithDescriptions should work with single value', (WidgetTester tester) async {
        final GlobalKey<State<CustomMultiThumbSlider<int>>> sliderKey = GlobalKey();
        List<int> currentValues = [50];
      ...
      test('getSegmentsWithDescriptions should work with empty values when called directly', () {
      ...
      testWidgets('getSegmentsWithDescriptions should throw for non-numeric types', (WidgetTester tester) async {
        final GlobalKey<State<CustomMultiThumbSlider<String>>> sliderKey = GlobalKey();
        ...
        final CustomMultiThumbSlider<String> slider = tester.widget(find.byKey(sliderKey));

        expect(() => slider.getSegmentsWithDescriptions(), throwsA(isA<UnsupportedError>()));
      });

      testWidgets('onDescriptionChanged callback should be called when description is edited', (
        WidgetTester tester,
      ) async {
        List<int> currentValues = [50];
      ...
      testWidgets('withInt factory should support onDescriptionChanged callback', (WidgetTester tester) async {
        List<int> currentValues = [50];
        bool callbackCalled = false;
      ...
      testWidgets('withEnum factory should support onDescriptionChanged callback', (WidgetTester tester) async {
        List<TestDifficulty> currentValues = [TestDifficulty.medium];
        bool callbackCalled = false;
      ...
      test('getSegmentsWithDescriptions should work without widget context', () {
        // Test the direct calculation when widget state is not available
        final slider = CustomMultiThumbSlider<int>(values: [30, 70], min: 0, max: 100, onChanged: (newValues) {});
      ...
      testWidgets('segment description feature should work with double values', (WidgetTester tester) async {
        final GlobalKey<State<CustomMultiThumbSlider<double>>> sliderKey = GlobalKey();
        List<double> currentValues = [25.5, 75.7];
        ...
        final CustomMultiThumbSlider<double> slider = tester.widget(find.byKey(sliderKey));
        final segments = slider.getSegmentsWithDescriptions();
      ...
      testWidgets('onDescriptionChanged should not be called without enableDescriptionEdit', (
        WidgetTester tester,
      ) async {
        List<int> currentValues = [50];
        bool callbackCalled = false;
      ...
      testWidgets('enableDescriptionEdit parameter should control icon visibility', (WidgetTester tester) async {
        List<int> currentValues = [50];
      ...
      testWidgets('enableDescriptionEdit should work independently of enableSegmentEdit', (WidgetTester tester) async {
