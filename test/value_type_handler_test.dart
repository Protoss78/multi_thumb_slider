...
void main() {
  group('NumericValueHandler Tests', () {
    ...
    group('getAllPossibleValues', () {
      ...
      test('double handler uses custom allPossibleValues when provided', () {
        ...
        final values = doubleHandler.getAllPossibleValues(0.0, 100.0, customValues);
        expect(values, equals(customValues));
      });
    });
    ...
    group('formatValue', () {
      ...
      test('uses custom formatter when provided', () {
        ...
        expect(intHandler.formatValue(42, customFormatter), equals('Value: 42'));
        expect(doubleHandler.formatValue(42.5, customDoubleFormatter), equals('Double: 42.5'));
      });
    });
  });
  ...
  group('EnumValueHandler Tests', () {
    ...
    group('toNormalized', () {
      test('converts enum values correctly', () {
        expect(enumHandler.toNormalized(TestDifficulty.easy, TestDifficulty.easy, TestDifficulty.expert), equals(0.0));
        expect(enumHandler.toNormalized(TestDifficulty.medium, TestDifficulty.easy, TestDifficulty.expert), equals(0.3333333333333333));
        expect(enumHandler.toNormalized(TestDifficulty.hard, TestDifficulty.easy, TestDifficulty.expert), equals(0.6666666666666666));
        expect(enumHandler.toNormalized(TestDifficulty.expert, TestDifficulty.easy, TestDifficulty.expert), equals(1.0));
      });

      test('handles reversed enum ranges', () {
        expect(enumHandler.toNormalized(TestDifficulty.expert, TestDifficulty.expert, TestDifficulty.easy), equals(0.0));
    ...
    group('fromNormalized', () {
      test('returns min value (limitation noted in implementation)', () {
        expect(enumHandler.fromNormalized(0.5, TestDifficulty.easy, TestDifficulty.expert), equals(TestDifficulty.easy));
        expect(enumHandler.fromNormalized(0.0, TestDifficulty.easy, TestDifficulty.expert), equals(TestDifficulty.easy));
        expect(enumHandler.fromNormalized(1.0, TestDifficulty.easy, TestDifficulty.expert), equals(TestDifficulty.easy));
      });
    });
    ...
    group('getAllPossibleValues', () {
      test('returns values in range when allPossibleValues provided', () {
        ...
        final values = enumHandler.getAllPossibleValues(TestDifficulty.easy, TestDifficulty.hard, allValues);
        expect(values, equals([TestDifficulty.easy, TestDifficulty.medium, TestDifficulty.hard]));
      });

      test('returns values in reversed range when allPossibleValues provided', () {
        final allValues = TestDifficulty.values;
        final values = enumHandler.getAllPossibleValues(TestDifficulty.hard, TestDifficulty.easy, allValues);
        expect(values, equals([TestDifficulty.easy, TestDifficulty.medium, TestDifficulty.hard]));
      });

      test('throws error when allPossibleValues is null', () {
        expect(
          () => enumHandler.getAllPossibleValues(TestDifficulty.easy, TestDifficulty.expert, null),
      ...
      test('filters values correctly based on range', () {
        final allValues = TestDifficulty.values;
        final values = enumHandler.getAllPossibleValues(TestDifficulty.medium, TestDifficulty.expert, allValues);
        expect(values, equals([TestDifficulty.medium, TestDifficulty.hard, TestDifficulty.expert]));
      });
    });
    ...
    group('formatValue', () {
      ...
      test('uses custom formatter when provided', () {
        ...
        expect(enumHandler.formatValue(TestDifficulty.easy, customFormatter), equals('Difficulty: easy'));
        expect(enumHandler.formatValue(TestDifficulty.hard, customFormatter), equals('Difficulty: hard'));
      });
    });
  });
  ...
  group('ValueTypeHandler Edge Cases', () {
    ...
    test('handles very large numbers', () {
      ...
      expect(() => intHandler.toNormalized(1000000, 0, 2000000), returnsNormally);
      expect(() => doubleHandler.toNormalized(1000000.0, 0.0, 2000000.0), returnsNormally);
      
      expect(intHandler.toNormalized(1000000, 0, 2000000), equals(0.5));
      expect(doubleHandler.toNormalized(1000000.0, 0.0, 2000000.0), equals(0.5));
    });

    test('handles very small numbers', () {
      final doubleHandler = NumericValueHandler<double>();
      
      expect(() => doubleHandler.toNormalized(0.000001, 0.0, 0.000002), returnsNormally);
